class MonsterPointSpend < ApplicationRecord
    ...
    validates_presence_of :character_points_gained, :if => :complete, on: :create, :message => I18n.t("character.monster_points.at_least_one")
    validates_numericality_of :character_points_gained, :greater_than => 0, :if => :complete, on: :create, :message => I18n.t("character.monster_points.at_least_one")

    validates_each :monster_points_spent, :if => :complete, on: :create do |record, attr, value|
    ...
    validates_each :character_points_gained, :if => :complete, on: :create do |record, attr, value|
