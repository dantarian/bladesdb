...
module FormErrorsHelper
  # Adapted from https://github.com/joelmoss/dynamic_form/blob/master/lib/action_view/helpers/dynamic_form.rb

  ActionView::Helpers::FormBuilder.class_eval do
    include ActionView::Helpers::TagHelper

    def error_messages(options = {})
      error_messages_for(@object_name, objectify_options(options))
    end
        ...
        I18n.with_options :locale => options[:locale], :scope => [:activerecord, :errors, :template] do |locale|
          ...
          error_messages = objects.sum do |object|
            object.errors.map do |err|
              content_tag(:li, err.full_message)
            end
          end.join.html_safe
